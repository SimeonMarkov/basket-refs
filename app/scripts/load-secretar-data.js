                ...
                data: [
                    {
                        ...
                        name: '<div class="data-list-item"> • отбор овладее “жива” топка на игралното поле\n' +
                        '. Незначителното докосване на \n' +
                        'топката от противник не стартира нов период на часовника за\n' +
                        '24 секунди, ако \n' +
                        'топката остава във владение на същият отбор;</div>'
                    }, {
                        name: '<div class="data-list-item"> • при  вкарване  на  топка  в  игра  отвън,  тя  докосне  или  е  редовно  докосната  от \n' +
                        'кой да е състезател в игралното поле.</div>'
                    }, {
                        name: '2.2 Се спира и се връща на 14 секунди. когато:'
                    }, {
                        name: '<div class="data-list-item"> • на  отбора,  който  е  бил  във  владение  на  топката  преди  това  се  дава  право \n' +
                        'да вкара топката в игра отвън в предното си поле и 13 или по-малко секунди \n' +
                        'са налице на таблото на часовника за 24 секунди в следствие на извършено нарушение от противниковия отбор.</div>'
                    }
                ]
            }]
        }];
