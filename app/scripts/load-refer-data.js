        ...
        var data = [{
            ...
            data: [{
                ...
                data: [{
                    ...
                    name: '<div class="data-list-item"> • 20 минути преди планираното начало на срещата;</div>'
                }, {
                    name: '<div class="data-list-item"> • когато прозвучи сигналът за край на игралното време на даден период.</div>'
                }, {
                    name: '1.6. Интервал от играта завършва:',
                }, {
                    name: '<div class="data-list-item"> • в  началото  на  първия  период,  когато  топката  напусне  ръката  или  ръцете  на старши-съдията при изпълнението на спорната топка;</div>'
                }, {
                    name: '<div class="data-list-item"> • в началото на всички останали периоди, когато топката е на разположение на състезателя, който ще я вкара в игра отвън .</div>'
                }]
            }]
        }, {
            ...
            data: [{
                ...
                data: [{
                    ...
                    name:'<div class="data-list-item"> • стрелба в коша от игра;</div>'
                }, {
                    name: '<div class="data-list-item"> • докосване на топката от противник;</div>'
                }, {
                    name: '<div class="data-list-item"> • подаване   или   положение   на   неовладяна   топка,   при   което   топката   е докоснала или е' +
                    ' била докосната от друг състезател.</div>'
                }]
            }, {
